...
// COL-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <4 x float> [[TMP0]], i64 0
// ROW-CHECK-NEXT:    [[M_COL:%.*]] = call {{.*}} <4 x float> @llvm.matrix.transpose.v4f32(<4 x float> [[TMP0]], i32 2, i32 2)
// ROW-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <4 x float> [[M_COL]], i64 0
// CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x float> poison, float [[MATRIX]], i64 0
// COL-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <4 x float> [[TMP0]], i64 2
// ROW-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <4 x float> [[M_COL]], i64 2
// CHECK-NEXT:    [[TMP2:%.*]] = insertelement <4 x float> [[TMP1]], float [[MATRIX1]], i64 1
// COL-CHECK-NEXT:    [[MATRIX2:%.*]] = extractelement <4 x float> [[TMP0]], i64 1
// ROW-CHECK-NEXT:    [[MATRIX2:%.*]] = extractelement <4 x float> [[M_COL]], i64 1
// CHECK-NEXT:    [[TMP3:%.*]] = insertelement <4 x float> [[TMP2]], float [[MATRIX2]], i64 2
// COL-CHECK-NEXT:    [[MATRIX3:%.*]] = extractelement <4 x float> [[TMP0]], i64 3
// ROW-CHECK-NEXT:    [[MATRIX3:%.*]] = extractelement <4 x float> [[M_COL]], i64 3
// CHECK-NEXT:    [[TMP4:%.*]] = insertelement <4 x float> [[TMP3]], float [[MATRIX3]], i64 3
// CHECK-NEXT:    store <4 x float> [[TMP4]], ptr [[V]], align 4
// CHECK-NEXT:    ret void
...
// COL-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <3 x i32> [[TMP0]], i64 0
// ROW-CHECK-NEXT:    [[M_COL:%.*]] = call <3 x i32> @llvm.matrix.transpose.v3i32(<3 x i32> [[TMP0]], i32 1, i32 3)
// ROW-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <3 x i32> [[M_COL]], i64 0
// CHECK-NEXT:    [[TMP1:%.*]] = insertelement <3 x i32> poison, i32 [[MATRIX]], i64 0
// COL-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <3 x i32> [[TMP0]], i64 1
// ROW-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <3 x i32> [[M_COL]], i64 1
// CHECK-NEXT:    [[TMP2:%.*]] = insertelement <3 x i32> [[TMP1]], i32 [[MATRIX1]], i64 1
// COL-CHECK-NEXT:    [[MATRIX2:%.*]] = extractelement <3 x i32> [[TMP0]], i64 2
// ROW-CHECK-NEXT:    [[MATRIX2:%.*]] = extractelement <3 x i32> [[M_COL]], i64 2
// CHECK-NEXT:    [[TMP3:%.*]] = insertelement <3 x i32> [[TMP2]], i32 [[MATRIX2]], i64 2
// CHECK-NEXT:    store <3 x i32> [[TMP3]], ptr [[V]], align 4
// CHECK-NEXT:    ret void
...
// COL-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <2 x i32> [[TMP1]], i64 0
// ROW-CHECK-NEXT:    [[M_COL:%.*]] = call <2 x i32> @llvm.matrix.transpose.v2i32(<2 x i32> [[TMP1]], i32 2, i32 1)
// ROW-CHECK-NEXT:    [[MATRIX:%.*]] = extractelement <2 x i32> [[M_COL]], i64 0
// CHECK-NEXT:    [[LOADED:%.*]] = icmp ne i32 [[MATRIX]], 0
// CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x i1> poison, i1 [[LOADED]], i64 0
// COL-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <2 x i32> [[TMP1]], i64 1
// ROW-CHECK-NEXT:    [[MATRIX1:%.*]] = extractelement <2 x i32> [[M_COL]], i64 1
// CHECK-NEXT:    [[LOADED1:%.*]] = icmp ne i32 [[MATRIX1]], 0
// CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i1> [[TMP2]], i1 [[LOADED1]], i64 1
// CHECK-NEXT:    [[TMP4:%.*]] = zext <2 x i1> [[TMP3]] to <2 x i32>
// CHECK-NEXT:    store <2 x i32> [[TMP4]], ptr [[V]], align 4
// CHECK-NEXT:    ret void
