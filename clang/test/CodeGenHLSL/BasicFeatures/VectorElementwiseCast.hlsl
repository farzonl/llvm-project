...
// COL-CHECK-NEXT:    [[MATRIXEXT:%.*]] = extractelement <2 x i32> [[TMP1]], i64 0
// ROW-CHECK-NEXT:    [[MATRIXEXT:%.*]] = extractelement <2 x i32> [[M_COL]], i64 0
// CHECK-NEXT:    [[LOADEDV:%.*]] = icmp ne i32 [[MATRIXEXT]], 0
// CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x i1> [[TMP2]], i1 [[LOADEDV]], i64 0
// COL-CHECK-NEXT:    [[MATRIXEXT1:%.*]] = extractelement <2 x i32> [[TMP1]], i64 1
// ROW-CHECK-NEXT:    [[MATRIXEXT1:%.*]] = extractelement <2 x i32> [[M_COL]], i64 1
