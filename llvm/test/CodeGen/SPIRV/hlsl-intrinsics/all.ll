...
entry:
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(i1 %a)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(i64 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(i32 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(i16 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(double %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(float %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(half %0)
  ret i1 %hlsl.all
}
...
entry:
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @__builtin_hlsl_elementwise_all(<4 x i1> %p0)
  ret i1 %hlsl.all
}

;declare i1 @__builtin_hlsl_elementwise_all(<4 x i1>)
;declare i1 @__builtin_hlsl_elementwise_all(i1)
declare i1 @__builtin_hlsl_elementwise_all(i16)
;declare i1 @__builtin_hlsl_elementwise_all(i32)
;declare i1 @__builtin_hlsl_elementwise_all(i64)
;declare i1 @__builtin_hlsl_elementwise_all(half)
;declare i1 @__builtin_hlsl_elementwise_all(float)
;declare i1 @__builtin_hlsl_elementwise_all(double)
